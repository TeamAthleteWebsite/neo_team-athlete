    ...
    <div className="relative">
      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative z-20 text-center space-y-6">
          ...
          <button style={{ backgroundColor: '#801d20cc' }} className="inline-block px-6 py-3 text-white text-sm font-medium hover:opacity-90 transition-opacity duration-300 font-helvetica rounded">
